...
public final class SearchSuspect extends Widget {
	...
	/**
	 * A widget showing a text field and a button. Used for searching the suspect's
	 * information.
	 */
	...
	private class ButtonListener implements ActionListener {
		...
		public void actionPerformed(ActionEvent e) {
			if (prompt.hasText()) {
				...
				if (s == null) {
					JOptionPane.showMessageDialog(Routes.getCurrFrame(), String.format("Suspect %s Not Found", name));
				} else {
					db.setSuspect(s);
