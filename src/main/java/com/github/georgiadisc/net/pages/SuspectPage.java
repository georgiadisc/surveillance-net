...
public final class SuspectPage extends Page {
	...
	/**
	 * The suspect page of our application, which includes the suspect's details,
	 * malicious messages exchanged with a specified number, their current and
	 * suggested partners, and the suspects coming from their home country.
	 */
	public SuspectPage() {
		super(600, 500);
