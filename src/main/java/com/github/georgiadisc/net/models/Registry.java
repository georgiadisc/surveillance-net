...
public class Registry {
     ...
     * whether it is a suspect that is already on the list potential partners.
     *
    ...
    /**
     * Adds an {@link SMS} or a {@link PhoneCall} to the corresponding list. If the communication
     * happened between the phone numbers Num1 and Num2, then the suspects who have the
     * corresponding numbers, will have their list of partners updated.
     *
    ...
    /**
     * It adds the suspects to the graph, as vertices, and the relationship between them, as edges.
     */
    ...
    /**
     * Returns the messages exchanged between the specified numbers, which contain at least one of
     * the words “Bomb”, “Attack”, “Explosives”, “Gun”.
     *
    ...
    /**
     * Returns the greatest possible distance that one suspect has from another suspect using BFS
    ...
    /**
     * Checks if the specified suspects have communicated at least once, either through an
     * {@link SMS} or a {@link PhoneCall}.
     *
