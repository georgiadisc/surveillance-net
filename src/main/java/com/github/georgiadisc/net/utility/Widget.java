...
/**
 * The parent class of every widget. Widgets extending this class get access to the database and the
 * mechanism for building and updating its content. The default updating mechanism is set to always.
 */
